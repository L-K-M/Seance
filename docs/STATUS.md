...
- `seance_core/test/test_connection_test.dart` — the trial connection: it
  ...
  than "Unsupported operation:", and flags a configured jump host; plus
  `UnpinnedHostKeyStore` reading existing pins through while keeping its own
  to the attempt.
