...
Historical review-first snapshot. Current unfinished work, implementation PRs and
verification live in [ANALYSIS.md](ANALYSIS.md). Findings below describe the review
base, not claims that subsequently fixed bugs remain present.
